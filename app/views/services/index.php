...
<section class="page-hero">
    <div class="container">
        ...
        <p>Twee warme opvangvormen. Kinder ontdekken og spelen in een veilige groene omgeving.</p>
    </div>
</section>
...
<section class="treatments section">
    <div class="container">
        <div class="section-head">
            ...
            <h2>Which <em>opvang</em> past for uw?</h2>
        </div>
        ...
        <div class="groups-grid">
            <?php foreach ($groups as $g): ?>
                <div class="group-card reveal">
                    ...
                    <span class="group-max">Max. <?php echo (int)$g['max_children']; ?> children</span>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<section class="hours section">
    <div class="container">
        <div class="section-head">
            ...
            <h2>We are <em>dagleek</em> for uw</h2>
        </div>
