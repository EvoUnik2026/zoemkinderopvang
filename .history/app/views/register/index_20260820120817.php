...
<section class="page-hero">
    <div class="container">
        ...
        <p>Gratis en vrijblijvend. Proef de warme sfeer en bekijk de groep.</p>
    </div>
</section>
...
<section class="register section">
    <div class="container" style="max-width:860px;">
        ...
        <p class="lead">Vul het formulier in, kies een opvang en een gewenste datum. Wij bevestigen uw bezoek snel.</p>
        ...
        <form method="post" action="<?php echo $base_url; ?>/register" class="contact-form" novalidate>
            ...
            <div class="form-grid">
                ...
                <div class="field field-full">
                    ...
                    <textarea id="rg-msg" name="message" rows="4" placeholder="Alles wat u wilt delen..."></textarea>
                </div>
